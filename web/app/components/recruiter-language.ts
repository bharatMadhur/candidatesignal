...
export const RECRUITER_COPY = {
  ...
  requirementAssistant: "Requirement Builder",
  matchingButton: "Find Matching Candidates",
  candidateReportSubtitle:
    "Facts, AI interpretation, source evidence, and recruiter notes are separated so the profile is easy to trust.",
} as const;
