...
STAGING_DOMAIN="${STAGING_DOMAIN:-staging.candidatesignal.ai}"
ARTIFACT_REPOSITORY="${ARTIFACT_REPOSITORY:-candidatesignal}"
DOCUMENT_BUCKET="${DOCUMENT_BUCKET:-candidatesignal-prod-documents}"
STAGING_DOCUMENT_BUCKET="${STAGING_DOCUMENT_BUCKET:-candidatesignal-staging-documents}"
...
STAGING_SQL_DATABASE="${STAGING_SQL_DATABASE:-resume_intel_staging}"
STAGING_SQL_USER="${STAGING_SQL_USER:-resume_intel_staging}"
